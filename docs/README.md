...
The deployment url is: [https://arquisoft.github.io/wichat_en1b/](https://arquisoft.github.io/wichat_en1b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_en1b/](https://arquisoft.github.io/wichat_en1b/), we need to execute `npm run deploy`.
